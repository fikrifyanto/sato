    ...
    <main>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                                ...
                                <div class="hero__caption">
                                    ...
                                    <a href="#" class="hero-btn" data-animation="fadeInLeft" data-delay=".3s">Contact
            ...
            <div class="container fix">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            ...
                            <div class="gallery-img size-img"
                                style="background-image: url({{ asset('petcare-master/assets/img/gallery/gallery1.png') }});">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img"
                                style="background-image: url({{ asset('petcare-master/assets/img/gallery/gallery2.png') }});">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img"
                                style="background-image: url({{ asset('petcare-master/assets/img/gallery/gallery3.png') }});">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4  col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img"
                                style="background-image: url({{ asset('petcare-master/assets/img/gallery/gallery4.png') }});">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="contact-form-main pb-top">
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="form-wrapper">
                            ...
                            <form id="contact-form" action="#" method="POST">
                                ...
                                <!-- shape-dog -->
                                <div class="shape-dog">
                                    <img src="{{ asset('petcare-master/assets/img/gallery/shape1.png') }}" alt="">
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="from-left d-none d-lg-block">
                <img src="{{ asset('petcare-master/assets/img/gallery/contact_form.png') }}" alt="">
            </div>
        </div>
        <!-- Contact form End -->
        <!--? Team Start -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('petcare-master/assets/img/gallery/team1.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('petcare-master/assets/img/gallery/team2.png') }}" alt="">
                            </div>
                            <div class="team-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('petcare-master/assets/img/gallery/team3.png') }}" alt="">
                            </div>
                            <div class="team-caption">
        ...
        <div class="testimonial-area testimonial-padding section-bg"
            data-background="{{ asset('petcare-master/assets/img/gallery/section_bg03.png') }}">
            <div class="container">
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-founder">
                                        <div class="founder-img mb-40">
                                            <img src="{{ asset('petcare-master/assets/img/gallery/testi-logo.png') }}"
                                                alt="">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="{{ asset('petcare-master/assets/img/gallery/blog1.png') }}" alt="">
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Pet food</span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="{{ asset('petcare-master/assets/img/gallery/blog2.png') }}" alt="">
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Pet food</span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="{{ asset('petcare-master/assets/img/gallery/blog3.png') }}" alt="">
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Pet food</span>
        ...
        <div class="contact-animal-owner section-bg"
            data-background="{{ asset('petcare-master/assets/img/gallery/section_bg04.png') }}">
            <div class="container">
